...
namespace R03546012許芸瑄Ass06
{
    class BinaryOperatedFuzzySet : FuzzySet
    {
        ...
        public BinaryOperatedFuzzySet(BinaryOperator bo, FuzzySet fs1, FuzzySet fs2) : base(fs1.universe) //繼承需要universe但這裡的universe是原本fuzzyset來的
        {
            ...
            line.Name = title;
            updateDataPoints();
            fs1.ParameterChanged += theFuzzySet1_ParameterChanged;
            fs2.ParameterChanged += theFuzzySet2_ParameterChanged;
        }
        void theFuzzySet1_ParameterChanged(double e) { updateDataPoints(); }
        void theFuzzySet2_ParameterChanged(double e) { updateDataPoints(); }
